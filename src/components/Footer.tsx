        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Transformando o aprendizado com inteligência artificial
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#benefícios" className="text-gray-400 hover:text-white">Benefícios</a></li>
              <li><a href="#preços" className="text-gray-400 hover:text-white">Preços</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/privacidade" className="text-gray-400 hover:text-white">Privacidade</a></li>
              <li><a href="/termos" className="text-gray-400 hover:text-white">Termos</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 GreekMind. Todos os direitos reservados.
            </p>
